    ...
    <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="form-card">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="mcaz_licensed_person" class="form-control" value="{{ old('mcaz_licensed_person', $supplier->mcaz_licensed_person) }}" placeholder="Name of the MCAZ-licensed responsible person">
            </div>
            <div class="col-md-6">
                <label class="form-label">Wholesale License Number</label>
                <input type="text" name="wholesale_license_number" class="form-control" value="{{ old('wholesale_license_number', $supplier->wholesale_license_number) }}">
            </div>
            <div class="col-md-6">
